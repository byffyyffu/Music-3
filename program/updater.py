...
@Client.on_message(command(["دث", "update", f"update@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
...
@Client.on_message(command(["يستارت","restart", f"restart@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
